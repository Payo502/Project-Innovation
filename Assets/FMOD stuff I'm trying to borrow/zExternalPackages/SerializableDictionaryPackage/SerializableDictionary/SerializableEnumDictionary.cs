...
namespace SerializableDictionaryPackage.SerializableDictionary
{
        ...
        where TKey : struct, Enum
    {
        ...
        public SerializableEnumDictionary(params SerializableKeyValuePair<TKey, TValue>[] keyValuePairs) : base(
        ...
        public static implicit operator SerializableEnumDictionary<TKey, TValue>(
        ...
        public static implicit operator Dictionary<TKey, TValue>(
            SerializableEnumDictionary<TKey, TValue> serializableDictionary)
        {
        ...
        {
            EnumDictionaryUtil.PopulateEnumDictionary<SerializableKeyValuePair<TKey, TValue>, TKey, TValue>(
