...
namespace SerializableDictionaryPackage.SerializableDictionary
{
        ...
        ISerializationCallbackReceiver
    {
        ...
        [SerializeField] protected List<SerializableKeyValuePair<TKey, TValue>> serializedDictionary = new();

        protected List<SerializableKeyValuePair<TKey, TValue>> InternalList = new();

        #endregion

        #region Operators

        public static explicit operator SerializableDictionary<TKey, TValue>(
        ...
        public static implicit operator Dictionary<TKey, TValue>(
            SerializableDictionary<TKey, TValue> serializableDictionary)
        {
            return serializableDictionary.InternalList.ToDictionary(pair => pair.Key,
        ...
        public SerializableDictionary(params SerializableKeyValuePair<TKey, TValue>[] keyValuePairs) : this(
            keyValuePairs.Distinct())
        {
        }
        ...
        {
            return ToKeyValuePair().GetEnumerator();
        }
        ...
        {
            return ((Dictionary<TKey, TValue>)this).GetEnumerator();
        }
