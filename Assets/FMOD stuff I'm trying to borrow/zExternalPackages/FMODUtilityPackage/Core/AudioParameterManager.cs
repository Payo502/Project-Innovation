...
namespace FMODUtilityPackage.Core
{
    ...
    {
        private static readonly Dictionary<string, PARAMETER_ID> globalParameters = new();

        private static readonly Dictionary<string, Bus> buses = new();
        ...
        /// <param name="updateCached">
        ///     Update the cached value as well (the cached value is used to get the old volume when you
        ///     unmute)
        /// </param>
        ...
        {
            if (updateCached) masterVolume = volume;
