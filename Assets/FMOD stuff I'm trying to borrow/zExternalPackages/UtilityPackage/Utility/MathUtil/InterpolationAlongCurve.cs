...
{
	/// <summary>
	///     A class that interpolates between <see cref="ValueA" /> and <see cref="ValueB" /> using an
    ...
    public class InterpolationAlongCurve
    {
        ...
        [SerializeField] [ReadOnly] private float minTime;

        [SerializeField] [ReadOnly] private float maxTime;

        [SerializeField] [ReadOnly] private float minValue;

        [SerializeField] [ReadOnly] private float maxValue;

        /// <summary>
        ///     <para>The first value used for interpolation.</para>
        ///     <para>This will be returned for an interpolation value of 0.</para>
        /// </summary>
        [Space] [Header("Values")] public float ValueA;
        ...
        public InterpolationAlongCurve(AnimationCurve animationCurve, float valueA, float valueB)
        {
            ...
            if (curve != null) RecalculateValues();
        ...
        /// <summary>
        ///     The current curve used for retrieving the interpolation value between <see cref="ValueA" /> and
        ///     <see cref="ValueB" />
        /// </summary>
        ...
        public float MinTime
        {
            get
            {
                if (!hasCalculatedValues) RecalculateValues();
        ...
        /// <summary>
        ///     Returns an interpolated value between <paramref name="valueA" /> and <paramref name="valueB" /> based on the result
        ///     of the <see cref="Curve" /> at <paramref name="time" />
        /// </summary>
        /// <param name="valueA">
        ///     <see cref="ValueA" />
        /// </param>
        ...
        /// <summary>
        ///     Returns an interpolated value between <see cref="ValueA" /> and <see cref="ValueB" /> based on the result of the
        ///     <see cref="Curve" /> at <paramref name="time" />
        /// </summary>
        /// <param name="time">The time to evaluate the curve for the interpolation value</param>
        /// <returns>An (unclamped) interpolated value between A and B</returns>
        ...
        /// <summary>
        ///     Returns an interpolated value between <paramref name="valueA" /> and <paramref name="valueB" /> based on the result
        ///     of the <see cref="Curve" /> at <paramref name="normalizedTime" />
        /// </summary>
        /// <param name="valueA">
        ///     <see cref="ValueA" />
        /// </param>
        ...
        /// <summary>
        ///     Returns an interpolated value between <see cref="ValueA" /> and <see cref="ValueB" /> based on the result of the
        ///     <see cref="Curve" /> at <paramref name="normalizedTime" />
        /// </summary>
        /// <param name="normalizedTime">a normalized value that represents the % of the <see cref="MaxTime" /></param>
        /// <returns>An (unclamped) interpolated value between A and B</returns>
