...
{
	/// <summary>
	///     An abstract representation of a component used by the <seealso cref="CursorComponentManager" /> to change cursor
	///     textures and add cursor effects
	/// </summary>
	public abstract class AbstractCursorComponent : BetterMonoBehaviour
    {
	    ...
	    /// <summary>
	    ///     <para>
	    ///         Whether the <see cref="CursorComponentManager" /> should call <see cref="GetCursorData" /> to update the
	    ///         cursor texture
	    ///     </para>
	    /// </summary>
	    ...
	    ///     <para>
	    ///         This is called every <see cref="CursorComponentManager.LateUpdate" /> in the
	    ///         <see cref="CursorComponentManager" />
	    ///     </para>
	    /// </summary>
