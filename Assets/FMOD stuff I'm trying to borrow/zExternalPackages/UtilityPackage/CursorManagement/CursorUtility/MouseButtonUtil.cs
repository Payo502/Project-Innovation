...
namespace UtilityPackage.CursorManagement.CursorUtility
{
    ...
    public class MouseButtonUtil : Singleton<MouseButtonUtil>
    {
        ...
        /// <param name="eye">
        ///     By default, <see cref="Camera.MonoOrStereoscopicEye.Mono" />. Can be set to
        ///     <see cref="Camera.MonoOrStereoscopicEye.Left" /> or <see cref="Camera.MonoOrStereoscopicEye.Right" /> for use in
        ///     stereoscopic rendering (e.g., for VR).
        /// </param>
        ...
        public static Ray GetMouseToWorldRay(Camera camera,
            Camera.MonoOrStereoscopicEye eye = Camera.MonoOrStereoscopicEye.Mono)
        {
        ...
        protected override void Awake()
        {
            ...
            if (!mouseButtonHandlers.Any(handler =>
